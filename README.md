<h1 align="center">Develooper Test 4Cadia</h1>

Junior Front End Vacancy Test

* Teste de vacância de front end júnior
...
<p> Para iniciar o projeto, você deve ter NodeJs no seu computador `https: // nodejs.org / en /` </p>
<p> e também git developer `https: // git-scm.com / download / win` </p>
<p> siga as instruções de `https: // git-scm.com / book / en / v2 / Getting-Started-Connecting-Git` </p>
<p> e NPM com o seguinte comando em seu prompt `npm install -g npm` </p>
...
* ## Servidor de projeto em execução

<p> Execute `ng serve` para um servidor de desenvolvimento. Navegue até `http: // localhost: 4200 /`. </p>
<p> O aplicativo será recarregado automaticamente se você alterar qualquer um dos arquivos de origem. </p>
...
dentro do módulo estão os componentes principais
`body-home`
`extrair`
`casa`
`login`
...
`retirar`
sendo exportado.
o módulo está falando
importado para app.module.ts com todos os componentes.
sem estilo de ampliação, tem um padrão de `material.angular` ..
bibliotecas são de 'material.angular'
...
* ## quarto: página de saldo
na página de saldo você tem:
<p>data do movimento</p>
<p>Descrição</p>
<p>histórico</p>
<p>Saldo</p>

onde mostra as despesas do cliente e quanto ele leva em consideração.
usando a página inicial estática da página home, ele apenas altera o conteúdo e o menu e a head é fixada

* ## quinta: página de extrato
A página de extrato contém as informações recebidas sobre a conta.
a informação está sendo usada em componet.ts.

* ## por ultimo tem o link para sair da conta 